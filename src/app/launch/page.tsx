    ...
    <main className="relative overflow-hidden h-[calc(100dvh-56px)] flex items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center gap-16 scale-110 md:scale-125">
        ...
        <div className="flex justify-center">
          <Link href="/setup">
            <Button type="button" className="px-12 py-7 rounded-3xl text-sm font-bold uppercase tracking-widest shadow-[0_20px_50px_rgba(10,116,255,0.3)] hover:shadow-[0_20px_60px_rgba(10,116,255,0.5)]">
